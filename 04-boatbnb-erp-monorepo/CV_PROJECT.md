...
## Screenshots
See `screenshots/` — **mobile app** (splash, search, yacht/jet-ski categories, services, rental type, detail, profile, bookings) + Vue admin dashboard.

Mobile UI based on BoatBnB design system (375px): search, yacht_boat, jet_ski_sea, services, rental_type, user_app, card components.

## Login (demo)
- Mobile: guest flow · Admin: `/login` on Vue SPA
