...
Complete portfolio deliverables for 9 production projects: CV docs, screenshots, website, GitHub READMEs, architecture diagrams, API docs, CI/CD examples, and case studies.
...
| **CV Project Docs** | `01-*` … `09-*` folders | Per-project CV text + screenshots |
